...
it('la fuente de marca resuelve a un asset CSS realmente compilado por Vite', function () {
    // Regresión: si la entrada de vite.config.js se borra accidentalmente
    ...
    $path = ThemeResolver::fontAssetPath();
